      ...
      {exercises?.map((exercise: IExerciseInterface) => (
        <Box
          ...
          <Flex minWidth='max-content'>
            <Spacer /> <CloseButton onClick={() => handleWithDeleteExercise(exercise.id!)} size='sm' />                      
          </Flex> 
          ...
          <chakra.h1 fontSize='lg' lineHeight={6}>
              Séries: 
            <Editable defaultValue={`${exercise.sets}` ? `${exercise.sets}` : '0'}>
              <EditablePreview />
              <EditableInput  
                value={sets}
          ...
          <chakra.h1 fontSize='lg' lineHeight={6}>
            Carga: 
            <Editable defaultValue={`${exercise.weight}` ? `${exercise.weight}` : '0'}>
              <EditablePreview />
              <EditableInput  
                value={weight}
          ...
          <chakra.h1 fontSize='lg' lineHeight={6}>
            Descrição: 
            <Editable defaultValue={exercise.describe ? exercise.describe : 'Sem descrição'}>
              <EditablePreview />
              <EditableInput  
                value={describe}
